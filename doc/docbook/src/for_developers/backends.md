...
- [Bibliothek][bibli-wila-ch] - a simple program for verifying the book doesn't contain any broken links
- [mdbook-epub] - an EPUB renderer
- [mdbook-epub](https://github.com/Michael-F-Bryan/mdbook-epub "test") -Test ein EPUB Renderer
...
[bibli-wila-ch]: https://www.bibli-wila.ch	"Bibliothek Wila"
